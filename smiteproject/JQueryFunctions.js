...
$(".babylonian").append("<button class=\"btn\" onClick=\"filterSelection('babylonianFilter')\"><svg class='icon-babylonian c'><rect><title>Babylonian</title></rect></svg>");
...
$(".great-old-ones").append("<button class=\"btn\" onClick=\"filterSelection('great-old-onesFilter')\"><svg class='icon-great-old-ones c'><rect><title>Great Old Ones</title></rect></svg>");
...
$(".voodoo").append("<button class=\"btn\" onClick=\"filterSelection('voodooFilter')\"><svg class='icon-voodoo c'><rect><title>Voodoo</title></rect></svg>");
$(".yoruba").append("<button class=\"btn\" onClick=\"filterSelection('yorubaFilter')\"><svg class='icon-yoruba c'><rect><title>Yoruba</title></rect></svg>");

//Insert attack range specific icons
$(".melee").append("<button class=\"btn\" onClick=\"filterSelection('meleeFilter')\"><svg class='icon-melee c'><rect><title>Melee</title></rect></svg>");
$(".ranged").append("<button class=\"btn\" onClick=\"filterSelection('rangedFilter')\"><svg class='icon-ranged c'><rect><title>Ranged</title></rect></svg>");

//Insert attack type specific icons
$(".physical").append("<button class=\"btn\" onClick=\"filterSelection('physicalFilter')\"><svg class='icon-physical c'><rect><title>Physical</title></rect></svg>");
$(".magical").append("<button class=\"btn\" onClick=\"filterSelection('magicalFilter')\"><svg class='icon-magical c'><rect><title>Magical</title></rect></svg>");


//colourise clicked icons (in conjunction with css classes)
$(".btn").click(function(){
  $(".btn").not(this).children().removeClass("c");
